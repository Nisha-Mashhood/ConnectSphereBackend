...
export declare class CollaborationRepository extends BaseRepository<ICollaboration> implements ICollaborationRepository {
    private _mentorRequestModel;
    constructor();
    private toObjectId;
    ...
    findByIdAndUpdateWithPopulate: (id: string, update: Partial<ICollaboration>, options?: {
        new: boolean;
