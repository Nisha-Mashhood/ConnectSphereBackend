...
export declare class NotificationRepository extends BaseRepository<IAppNotification> implements INotificationRepository {
    constructor();
    private toObjectId;
    ...
    findNotificationByRelatedId: (relatedId: string, options: {
        userId: string;
        type: string;
