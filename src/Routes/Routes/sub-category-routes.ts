...
import { createSubcategorySchema, subcategoryParamSchema, updateSubcategorySchema } from '../../validations/subcategory-validators';
...
router.put(SUBCATEGORY_ROUTES.UpdateSubcategory, [apiLimiter, authMiddleware.verifyToken, authMiddleware.authorize('admin'), upload.single('image'), validate(updateSubcategorySchema)], subcategoryController.updateSubcategory);
